...
<div class="">
    ...
    <pre class="prettyprint linenums lang-php">
<?=htmlentities('<?=JS::includeHeaderFiles()?>')?>
    </pre>
    <p>
        The function <code>JS::includeHeaderFiles()</code> has <b>no parameter</b>.<br />
...
<?=htmlentities('<?=JS::includeAfterBodyFiles()?>')?>
    ...
    <p>
        The function <code>JS::includeAfterBodyFiles()</code> has <b>no parameter</b>.<br />
        It creates a &lt;script&gt; tag for each file you put in the list.
    </p>
        <pre class="prettyprint linenums lang-php">
    <?=htmlentities('<?=JS::addAfterBody("pub/app/script.js")?>
